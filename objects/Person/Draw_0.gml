...
draw_sprite_ext(sprite_index, image_index, x, draw_y, current_xscale, image_yscale, image_angle, image_blend, image_alpha)
draw_sprite_ext(hands_sprite_index, image_index, x, draw_y, current_xscale, image_yscale, image_angle, image_blend, image_alpha)

if selected {
	offset_x = x-sprite_xoffset-4
	offset_y = y-sprite_yoffset-3
