if !target or !instance_exists(target) {
	...
	if closest {
		...
		// @TODO: loop through potential positions here instead, check for collision lines
		var target_location_x = lengthdir_x(closest_distance - (closest_distance*2 / 3), closest_direction)
		var target_location_y = lengthdir_y(closest_distance - (closest_distance*2 / 3), closest_direction)
